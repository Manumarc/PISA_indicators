...
```{r Transformación de formato de bases}

bd01 <- pisa_to_scldata(bd_apr, "Aprendizaje")

bd02 <- pisa_to_scldata(bd_rf, "Recursos")

bd_integrada <- rbind(bd01,bd02)

# Guardado de datos

write.xlsx(bd_integrada, file = "01 Bases/Indicadores_PISA_20260805.xlsx")
